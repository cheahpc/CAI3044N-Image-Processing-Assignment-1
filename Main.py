...
cr_gti_el_h_1 = round(os.path.getsize(path_gti_h) / os.path.getsize(path_el_h_1), 4)
cr_gti_el_h_2 = round(os.path.getsize(path_gti_h) / os.path.getsize(path_el_h_2), 4)
cr_gti_el_h_3 = round(os.path.getsize(path_gti_h) / os.path.getsize(path_el_h_3), 4)
cr_gti_el_h_4 = round(os.path.getsize(path_gti_h) / os.path.getsize(path_el_h_4), 4)
cr_gti_el_h_5 = round(os.path.getsize(path_gti_h) / os.path.getsize(path_el_h_5), 4)
cr_gti_el_h_6 = round(os.path.getsize(path_gti_h) / os.path.getsize(path_el_h_6), 4)
cr_gti_el_h_7 = round(os.path.getsize(path_gti_h) / os.path.getsize(path_el_h_7), 4)
cr_gti_el_h_8 = round(os.path.getsize(path_gti_h) / os.path.getsize(path_el_h_8), 4)
cr_gti_el_v_1 = round(os.path.getsize(path_gti_v) / os.path.getsize(path_el_v_1), 4)
cr_gti_el_v_2 = round(os.path.getsize(path_gti_v) / os.path.getsize(path_el_v_2), 4)
cr_gti_el_v_3 = round(os.path.getsize(path_gti_v) / os.path.getsize(path_el_v_3), 4)
cr_gti_el_v_4 = round(os.path.getsize(path_gti_v) / os.path.getsize(path_el_v_4), 4)
cr_gti_el_v_5 = round(os.path.getsize(path_gti_v) / os.path.getsize(path_el_v_5), 4)
cr_gti_el_v_6 = round(os.path.getsize(path_gti_v) / os.path.getsize(path_el_v_6), 4)
cr_gti_el_v_7 = round(os.path.getsize(path_gti_v) / os.path.getsize(path_el_v_7), 4)
cr_gti_el_v_8 = round(os.path.getsize(path_gti_v) / os.path.getsize(path_el_v_8), 4)
