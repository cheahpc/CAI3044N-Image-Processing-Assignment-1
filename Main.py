...
cr_gti_sg_h_1 = f.Compute.compressionRatio(gti_h, sg_h_1)
cr_gti_sg_h_2 = f.Compute.compressionRatio(gti_h, sg_h_2)
cr_gti_sg_h_3 = f.Compute.compressionRatio(gti_h, sg_h_3)
...
# ----------------------------------------------------------------------------------------------------------- Show - Information
# Information
print("raw_h image: ", raw_h.shape, " | Type: ", f.Image.getImageType(raw_h), " | Size: ", raw_h.size)
print("raw_v image: ", raw_v.shape, " | Type: ", f.Image.getImageType(raw_v), " | Size: ", raw_v.size)
print("gti_h image: ", gti_h.shape, " | Type: ", f.Image.getImageType(gti_h), " | Size: ", gti_h.size)
print("gti_v image: ", gti_v.shape, " | Type: ", f.Image.getImageType(gti_v), " | Size: ", gti_v.size)
...
# Compression Ratio - Smoothed
print("Compression Ratio GTI X Smoothed Gaussian 1 (Horizontal):", cr_gti_sg_h_1)
print("Compression Ratio GTI X Smoothed Gaussian 2 (Horizontal):", cr_gti_sg_h_2)
print("Compression Ratio GTI X Smoothed Gaussian 3 (Horizontal):", cr_gti_sg_h_3)
print("Compression Ratio GTI X Smoothed Gaussian 1 (Vertical):", cr_gti_sg_h_1)
